...
public class AddEventRequest extends StringRequest {
  ...
  //  private static final String REGISTER_REQUEST_URL = "https://terminological-hois.000webhostapp.com/addevent.php";
    ...
    public AddEventRequest(String eventName, String date, String time, String location,String enrollmentid, Response.Listener<String> listener,Response.ErrorListener errorListener) {
